    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reported_time', models.DateTimeField(null=True, verbose_name='time report')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('profile_img', models.ImageField(blank=True, null=True, upload_to='profile_image/', verbose_name='Profiel Image')),
